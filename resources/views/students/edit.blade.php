                ...
                <form action="{{route('students.update',$student->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="name" id="name" value="{{old('name',$student->name)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.EntertheName')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">{{__('students.DateofBirth')}}</label>
                                    <input type="date" name="date_of_birth" id="date_of_birth" value="{{old('date_of_birth',$student->date_of_birth)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.Enterthedateofbirth')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">{{__('students.ClassStartDate')}}</label>
                                    <input type="date" name="class_start_date" id="class_start_date" value="{{old('class_start_date',$student->class_start_date)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('studentsEntertheclassstartdate.')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="civil_id" id="civil_id" value="{{old('civil_id',$student->civil_id)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.EntertheCivilID')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="nationality" id="nationality" value="{{old('nationality',$student->nationality)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.EntertheNationality')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">{{__('students.PlaceOfBirth')}}</label>
                                    <input type="text" name="place_of_birth" id="place_of_birth" value="{{old('place_of_birth',$student->place_of_birth)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.EntertheAddress')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">{{__('students.Address')}}</label>
                                    <input type="text" name="address" id="address" value="{{old('address',$student->address)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.Enter the Addres')}}s" />
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">{{__('students.TelephoneNumber')}}</label>
                                    <input type="string" name="telephone_number" id="telephone_number" value="{{old('telephone_number',$student->telephone_number)}}" class="form-control mb-4 mb-md-0" placeholder="{{__('students.EntertheTelephoneNumber')}}" />
                                </div>
                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="amount" id="amount"
                                        value="{{ old('amount', optional($student->payments->sortByDesc('created_at')->first())->amount) }}"
                                  ...
                                  <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="comment" id="comment" class="form-control" rows="5" placeholder="{{ __('students.comment') }}..."  >{{ old('comment', $student->comment) }}</textarea>
                                 
                                </div>
                                
                                <div class="col-md-12 mb-3">
                                    <label for="status" class="form-label">{{__('students.Status')}}Status</label>
                                    <select class="form-select" name="status" id="status">
                                        <option selected disabled>{{__('students.Select status')}}</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input gender-filter" name="gender" id="genderMale" value="Male" {{ old('gender', $student->gender ?? '') == 'Male' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="genderMale">{{__('students.Male')}}</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input gender-filter" name="gender" id="genderFemale" value="Female" {{ old('gender', $student->gender ?? '') == 'Female' ? 'checked' : '' }}>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select id="class_model_id" name="class_model_id" class="form-control select2">
                                        <option value="" selected disabled>{{__('students.Select Class')}}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 d-grid mb-2">
                                <button class="btn text-white" style="background:   #FFC107;" type="submit" name="is_test" value="0">{{__('students.Update')}}</button>
                            </div>
                            @else
                            <div class="col-md-3 d-grid mb-2">
                                <button class="btn text-white" style="background-color:#042954 ;" type="submit" name="is_test" value="0">{{__('students.Update')}}</button>
                            </div>
                            @endif
                        </div>
                    </div>
